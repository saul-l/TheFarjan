...
[CreateAssetMenu(fileName = "ShipResourceManager", menuName = "Scriptable Objects/ShipResourceManager")]
public class ShipResourceManager : ScriptableObject
{
    // Basic resources
    [NonSerialized] public Dictionary<ShipResource, int> shipResources = new Dictionary<ShipResource, int>();

    public void Clear()
    {
        shipResources = new Dictionary<ShipResource, int>();
    }
